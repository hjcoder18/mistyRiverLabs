...
<div class="container">
	...
	<div class="row">
    	<div class="col-md-6">
	    {!! Form::open(['route' => 'editlitter.store', 'data-parsley-validate' => '', 'files' => true]) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-3 gallery_image">
        	<img src="{{ asset('images/litter/'.$gallery) }}" alt="No image found" height="245px" width="100%"/>
        	{!! Form::open(['method' => 'DELETE', 'route' => ['editlitter.destroy', $gallery], 'data-parsley-validate' => '', 'files' => true]) !!}
